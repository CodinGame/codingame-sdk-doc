...
Note that this document covers how to create a **Multiplayer** game. A **Solo** or an **Optimization** game is quite similar but requires some adjustments. See [What differs from a Solo or an Optimization game](./README_SOLO.md).
